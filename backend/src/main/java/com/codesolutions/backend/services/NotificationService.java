...
public class NotificationService implements INotificationService {
    ...
    public void sendProjectInviteNotification(Project project, User invitee, User inviter) {
        if(invitee.getEmail().contains("mpmt.com")) return; //Protection pour ne pas dépasser le quota de bouce rate de MailDiver.
    ...
    public void sendTaskAssignationNotification(Project project, Task task, User assignee, User assigner) {
        if(assignee.getEmail().contains("mpmt.com")) return; //Protection pour ne pas dépasser le quota de bouce rate de MailDiver.
